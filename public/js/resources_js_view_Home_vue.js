          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                page = _this.page;
                _context.next = 3;
                return fetch("http://alvariumsoft/api/employes?page=".concat(page), {
                  method: 'GET'
                });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    Tabl: _components_Table__WEBPACK_IMPORTED_MODULE_1__.default
  }
});
